...
class Subscription(models.Model):
    ...
    # Relación con el usuario dueño de la suscripción (opcional según lógica de negocio)
...
class Product(models.Model):
    ...
    # [cite_start]Validación: precio >= 0 [cite: 199]
...
class SaleItem(models.Model):
    ...
    price = models.DecimalField(max_digits=10, decimal_places=2, help_text="Precio unitario al momento de la venta")
